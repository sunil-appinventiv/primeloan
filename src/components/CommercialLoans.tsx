...
const specializedLoans = [
  { icon: GraduationCap, title: "School & Colleges", description: "Educational institution financing with flexible terms" },
  { icon: Hotel, title: "Hotels & Resorts", description: "Hospitality sector loans with competitive rates" },
  { icon: PartyPopper, title: "Banquet & Marriage Halls", description: "Event venue financing solutions" },
  { icon: Warehouse, title: "Warehouse & Godowns", description: "Storage facility loans for logistics businesses" },
  { icon: Heart, title: "Nursing Homes & Hospitals", description: "Healthcare facility financing options" },
  { icon: TreePine, title: "Marriage Gardens", description: "Outdoor venue and farmhouse loans" },
  { icon: Factory, title: "Industrial Property", description: "Manufacturing unit and factory financing" },
  { icon: Building, title: "Commercial Complex", description: "Shopping malls and office building loans" },
];
